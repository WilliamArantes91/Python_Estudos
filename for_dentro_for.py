"""Em uma fabrica você tem vários produtos e não pode deixar que os produtos fiquem em falta. Para isso, foi definido uma quantidade mínima
de estoque que os produtos precisam ter:
...
estoque = [[294, 125, 269, 208, 783, 852, 259, 371, 47, 102, 386, 87, 685, 686, 697, 941, 163, 631, 7, 714, 218, 670, 453],
...
fabricas = ['Manufacturing', 'Fábrica Hashtag', 'Python Manufaturas', 'Produções e Cia', 'Manufatura e Cia']
nivel_minimo = 50
tem = 0
...
for i,produto in enumerate(estoque):
    for item in produto:
        if item < nivel_minimo:
            print('A fabrica {} atingiu o mínimo de estoque e precisa de reposição!'.format(fabricas[i]))  
            break
